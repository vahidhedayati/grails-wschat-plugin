class WschatGrailsPlugin {
    ...
    def description = 'default websocket chat room plugin. Multi-chat room plugin, supports Admin privilages, kicking banning users. Camera/Audio support has been added. '
