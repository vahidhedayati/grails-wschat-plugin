	...
	if (jsonData.users!=null) {
		...
		jsonData.users.forEach(function(entry) {
			...
			if (entry.friends_rtc!=null) {
				sb1.push('\n<li class="dropdown-submenu btn-warning btn-xs"><a tabindex="-1" id="user-title" class="user-title glyphicon glyphicon-facetime-video glyphicon-volume-up" >'+entry.friends_rtc+'</a>\n');
				...
				sb1.push('<li class="btn-xs" id="sideBar"><a onclick="javascript:removefriend('+wrapIt(entry.friends_rtc)+', '+wrapIt(user)+');">Remove  '+entry.friends_rtc+' from friends list</a>\n');
				sb1.push('\n</li> ');
			...
			if (entry.friends_av!=null) {
				sb1.push('\n<li class="dropdown-submenu btn-warning btn-xs"><a tabindex="-1"  id="user-title" class="user-title glyphicon glyphicon-facetime-video">'+entry.friends_av+'</a>\n');
				sb1.push('<ul class="dropdown-menu">\n');
				sb1.push('<li class="btn-xs" id="sideBar">\n');
				...
				sb1.push('<li class="btn-xs" id="sideBar"><a onclick="javascript:removefriend('+wrapIt(entry.friends_av)+', '+wrapIt(user)+');">Remove  '+entry.friends_av+' from friends list</a>\n');
				sb1.push('\n</li> ');
			...
			if (entry.friends!=null) {
				sb1.push('\n<li class="dropdown-submenu btn-warning btn-xs"><a tabindex="-1" id="user-title" class="user-title" href="#">'+entry.friends+'</a>\n');
				sb1.push('<ul class="dropdown-menu">\n');
				sb1.push('<li class="btn-xs" id="sideBar">\n');
				...
				sb1.push('<li class="btn-xs" id="sideBar"><a onclick="javascript:removefriend('+wrapIt(entry.friends)+', '+wrapIt(user)+');">Remove  '+entry.friends+' from friends list</a>\n');
				sb1.push('\n</li> ');
			...
			if (entry.user_rtc!=null) {
				sb2.push('\n<li class="dropdown-submenu btn-xs" id="sideBar"><a tabindex="-1"  id="user-title" class="user-title glyphicon glyphicon-facetime-video glyphicon-volume-up">'+entry.user_rtc+'</a>\n');
			...
			if (entry.user_av!=null) {
				sb2.push('\n<li class="dropdown-submenu btn-xs" id="sideBar"><a tabindex="-1" id="user-title" class="user-title glyphicon glyphicon-facetime-video">'+entry.user_av+'</a>\n');
				sb2.push('<ul class="dropdown-menu">\n');
				sb2.push('<li class="btn-xs" id="sideBar">\n');
			...
			if (entry.user!=null) {
				sb2.push('\n<li class="dropdown-submenu btn-xs" id="sideBar"><a tabindex="-1" id="user-title" class="user-title" href="#">'+entry.user+'</a>\n');
				sb2.push('<ul class="dropdown-menu">\n');
				sb2.push('<li class="btn-xs" id="sideBar">\n');
			...
			if (entry.blocked!=null) {
				sb3.push('\n<li class="dropdown-submenu btn-danger btn-xs" id="sideBar"><a tabindex="-1" id="user-title" class="user-title">'+entry.blocked+'</a>\n');
