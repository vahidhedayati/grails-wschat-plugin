...
<div class="container">
	<g:formRemote  name="urlParams"  class="form-horizontal" url="[controller:'wsChat', action:'addBooking']" update="adminConfirmation"  onComplete="closeAdminModal();">
	...
	<div class='row'><div class='col-sm-8'><div class='form-group'>
		...
		<chat:complete
			...
			searchField='username' require="false" required="false"
			collectField='username'
			value=''/>
		<div id="selectedValues"></div>
	</div></div></div>

	<div class='row'><div class='col-sm-8'>	<div class='form-group'><div class="fieldcontain ${hasErrors(bean: bookingInstance, field: 'dateTime', 'error')} required">
		<label for="manager">
			<g:message code="dateTime.label" default="Start date/Time" />
		</label>
			<input type="text" name="dateTime" id="dateTime" value="${current}" />
	</div></div></div></div>
	<div class='row'><div class='col-sm-8'>	<div class='form-group'><div class="fieldcontain ${hasErrors(bean: bookingInstance, field: 'endDateTime', 'error')} required">
		<label for="manager">
